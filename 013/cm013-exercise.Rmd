...
p <- ggplot(mtcars, aes(hp, wt)) + 
    geom_point()
ggsave("my_plot.png", p) #can use jpg, pdf, png
```

/Users/miellemichaux/Documents/STAT54X/classesgit/013/
...
> svg images are essentially html code 

# Scales; Colour

Scale functions in `ggplot2` take the form `scale_[aesthetic]_[mapping]()`.

> scale = component of grammar of graphics
...
> gganimate package for animating package. Basically just adding an animation argument. 
> shiny package later on will be for more comprehensive interactivity 
